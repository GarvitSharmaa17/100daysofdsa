Problem1: Write a program to perform addition of two matrices having the same dimensions. The sum of two matrices is obtained by adding corresponding elements of the matrices.
Input:
...
Problem2:Given a 2D integer array matrix, return the transpose of matrix.
